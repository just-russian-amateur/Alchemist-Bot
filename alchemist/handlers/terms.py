...
async def terms(message: Message):
    ...
    await message.answer(
        'By starting to work with me you agree to the <a href="https://alexxxander-laptev.github.io/terms_for_alchemist_bot/Terms_of_Service.html">User Agreement</a> and <a href="https://alexxxander-laptev.github.io/terms_for_alchemist_bot/Privacy_Policy.html">Privacy Policy</a>\n\nYou can ask my developer any questions you have regarding the operation of the bot or the payment system through the feedback system using the command /support🙂\n\nAfter clicking the button below you can continue from where you left off',
        parse_mode='HTML',
        reply_markup=ok()
    )
